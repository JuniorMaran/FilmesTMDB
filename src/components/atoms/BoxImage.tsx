...
export const BoxImage: React.FC <BoxImageProps> = ({ moviePosterPath, size }) => {
    ...
    if (!moviePosterPath) {
        return (
            <div className="w-full bg-gray-700 rounded-md flex items-center justify-center h-[350px] aspect-[2/3]">
    ...
    return (
        <div className="w-full overflow-hidden rounded-md h-[350px] aspect-[2/3]">
            <img
