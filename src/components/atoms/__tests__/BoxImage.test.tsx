...
describe('BoxImage', () => {
    ...
    it('should render placeholder when moviePosterPath is undefined', () => {
        render(<BoxImage moviePosterPath={undefined as unknown as string} size="w300" />);
    ...
    it('should have height class for consistent sizing', () => {
        ...
        const imgContainer = container.querySelector('.h-\\[350px\\]');
        expect(imgContainer).toBeInTheDocument();
    });
    ...
    it('should omit src when getImagePath returns falsy', () => {
        (tmdbService.getImagePath as any).mockReturnValueOnce('');
